...
const Applicant = () => {
    ...
    return (
        <Paper elevation={0} sx={{ overflow: 'hidden', height: 'fit-content', display: 'flex', flexDirection: 'column', gap: '10px', borderRadius: '12px' }}>
            ...
            <Stack direction='row' sx={{ borderTop: 1, borderColor: 'divider', padding: 0 }}>
                <List sx={{ display: 'flex', width: '75%', padding: 0, height: '100%' }}>
